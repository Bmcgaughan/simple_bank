...
// DeletAccount mocks base method.
func (m *MockStore) DeletAccount(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletAccount", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeletAccount indicates an expected call of DeletAccount.
func (mr *MockStoreMockRecorder) DeletAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletAccount", reflect.TypeOf((*MockStore)(nil).DeletAccount), arg0, arg1)
}
